...
pub struct SpecialForm{
    f: fn(ast::Ast, &mut env::Env)->lval::LVal,
    repr: string::String,
}
...
impl SpecialForm{
    pub fn new(f:fn(ast::Ast, &mut env::Env)->lval::LVal, repr:string::String)->SpecialForm{
        SpecialForm{
            f:f,
            repr:repr.clone(),
        }
    }
    pub fn apply(self, tree: ast::Ast, environment: &mut env::Env) -> lval::LVal {
